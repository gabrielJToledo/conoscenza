    ...
    <section className="c-contact">
      <div className="c-contact__container">
        ...
        <div className="c-contact__contactContent">
          <form className='c-contact__form' action="sendEmail.php" method="post">
            <label className='c-contact__label' htmlFor="">Nome: *</label>
            <input className='c-contact__input' type="text" name="nome" placeholder='Digite seu nome...' />

            <label className='c-contact__label' htmlFor="">E-mail: *</label>
            <input className='c-contact__input' type="text" name="email" placeholder='Digite seu e-mail...' />

            <label className='c-contact__label' htmlFor="">Telefone: *</label>
            <input className='c-contact__input' type="tel" name="telefone" placeholder='Digite seu telefone...' />

            <label className='c-contact__label' htmlFor="">Mensagem: </label>
            <textarea className='c-contact__textArea c-contact__label' type="text" name="mensagem" placeholder='Digite sua mensagem...' />
